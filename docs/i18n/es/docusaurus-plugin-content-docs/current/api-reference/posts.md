...
<VegaLite spec={{
  ...
  "title": {
    "anchor": "start",
    "text": "Posts Distribution by Type"
  },
  "style": "cell",
  "data": [
    {
  ...
  "marks": [
    {
      ...
      "encode": {
        "update": {
          "tooltip": {
            "signal": "{\"post_type\": isValid(datum[\"post_type\"]) ? isArray(datum[\"post_type\"]) ? join(datum[\"post_type\"], '\\n') : datum[\"post_type\"] : \"\"+datum[\"post_type\"], \"count\": format(datum[\"count\"], \"\"), \"post_status\": isValid(datum[\"post_status\"]) ? isArray(datum[\"post_status\"]) ? join(datum[\"post_status\"], '\\n') : datum[\"post_status\"] : \"\"+datum[\"post_status\"]}"
          },
          "fill": {
            "scale": "color",
            "field": "post_status"
          ...
          "description": {
            "signal": "\"post_type: \" + (isValid(datum[\"post_type\"]) ? isArray(datum[\"post_type\"]) ? join(datum[\"post_type\"], ' ') : datum[\"post_type\"] : \"\"+datum[\"post_type\"]) + \"; count: \" + (format(datum[\"count\"], \"\")) + \"; post_status: \" + (isValid(datum[\"post_status\"]) ? isArray(datum[\"post_status\"]) ? join(datum[\"post_status\"], ' ') : datum[\"post_status\"] : \"\"+datum[\"post_status\"])"
          },
          "x": {
            "scale": "x",
            "field": "post_type"
