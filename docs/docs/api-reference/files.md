...
<VegaLite spec={{
  ...
  "data": {
    "values": [
      { "extension": ".php", "size": 168307 },
      { "extension": ".txt", "size": 20013 },
      { "extension": ".html", "size": 7407 }
    ]
  },
  "mark": { "type": "arc", "tooltip": true },
  "encoding": {
    "theta": { "field": "size", "type": "quantitative", "stack": true },
    "color": { "field": "extension", "type": "nominal", "scale": { "scheme": "tableau10" }, "legend": { "title": "Extension" } }
  }
}} />
